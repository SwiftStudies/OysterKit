...
internal enum STLRTokens : Int, TokenType, CaseIterable, Equatable {
    ...
    var rule : Rule {
        switch self {
            ...
            /// terminal
            case .terminal:
                return [    T.endOfFile.rule,    T.characterSet.rule,    T.characterRange.rule,    T.terminalString.rule,    T.regex.rule].choice.reference(.structural(token: self))
...
public struct STLR : Codable {
    ...
    public enum Literal : Codable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            throw DecodingError.valueNotFound(Expression.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Tried to decode one of Boolean,Int,String but found none of those types"))
        }
    ...
    public enum Terminal : Codable {
        ...
        enum CodingKeys : Swift.String, CodingKey {
            case characterRange,endOfFile,characterSet,terminalString,regex
        }
        ...
        public init(from decoder: Decoder) throws {
            ...
            throw DecodingError.valueNotFound(Expression.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Tried to decode one of CharacterRange,Swift.String,CharacterSet,TerminalString,Swift.String but found none of those types"))
        }
        public func encode(to encoder:Encoder) throws {
            var container = encoder.container(keyedBy: CodingKeys.self)
            switch self {
    ...
    public enum Expression : Codable {
        ...
        public init(from decoder: Decoder) throws {
            ...
            throw DecodingError.valueNotFound(Expression.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "Tried to decode one of Sequence,Element,Choice but found none of those types"))
        }
        public func encode(to encoder:Encoder) throws {
            var container = encoder.container(keyedBy: CodingKeys.self)
            switch self {
